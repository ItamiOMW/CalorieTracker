...
object Constants {
    ...
    const val DEFAULT_WEIGHT_GRAMS = 70000
    const val DEFAULT_DAILY_CALORIES = 2500
    ...
    const val MIN_HEIGHT_METERS = 0
    const val MAX_HEIGHT_METERS = 2

    const val MIN_HEIGHT_FEET = 2
    const val MAX_HEIGHT_FEET = 8

    const val MIN_INCHES = 0
    const val MAX_INCHES = 11

    const val MIN_CM_PER_METER = 0
    const val MAX_CM_PER_METER = 99
